...
public class CLClient03 {
	public static final String C_PATH_SUB = ChildrenListener.getcPath() + "/rabbit";  
        ...
        new Thread(new Runnable() {  
            ...
            public void run() {  
                try {  
                    ...
                    if(stat == null){  
                        client.create().withMode(CreateMode.EPHEMERAL).forPath(C_PATH_SUB, "rabbitData".getBytes(Charset.forName(ChildrenListener.getCharset())));  
                    }  
